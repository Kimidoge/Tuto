...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // myAdapter.addElements(versions);
        ...
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, " https://raw.githubusercontent.com/kenobicjj/android/main/tutorial4.json ", null,
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public int getItemCount() {
            return elements.size();  //should return 13 according to array size
        }
        ...
        class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public NetworkImageView imageView;  //pull image from network
